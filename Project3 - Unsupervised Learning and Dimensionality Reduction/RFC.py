...
plt.title("Cluster Score for K Mean (KM) on RFC " + Dataset)
...
plt.title("Fitness Time for K Mean (KM) on RFC " + Dataset)
plt.xlabel("K cluster")
...
plt.title("Cluster Score for Expectation Maximization (EM) on RFC " + Dataset)
fig.tight_layout()
plt.show()


# [EM] Plot the Fitness Time over K cluster
plt.title("Fitness Time for Expectation Maximization (EM) on RFC " + Dataset)
plt.xlabel("K cluster")
plt.ylabel("Fitness Time (s)")
#plt.ylim(0.0, 1.1)
lw = 2
